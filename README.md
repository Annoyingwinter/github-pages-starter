...
`FIELD / 100` 把页面当作一间可滚动的现场档案室：米白纸面、宋体中文主标题、信号红定位线与圆形观察窗构成开场，随后依次穿过外部、内部、人物和参访现场。四章使用红、鼠尾草绿、暖黄与深绿形成完全不同的空间记忆。视觉参考的是 MDX 公开表达的制作方法——镜头语言、叙事节奏、动效连续性与性能约束——没有复制其布局、品牌、代码或付费提示词。
...
- `field-v2.css`：第二套“日光档案室”艺术方向覆盖层；独立文件名用于绕过旧版样式缓存。
